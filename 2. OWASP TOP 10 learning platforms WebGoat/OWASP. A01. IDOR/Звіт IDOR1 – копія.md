...
![alt text](<1 authentification_tom_cat-1.png>)
...
![alt text](<2 observing-1.png>)

Переглядаємо  httphistory у burpsuit та знаходимо відмінності:

![alt text](<3 observing_burpsuit-1.png>)

Як результат - цей крок пройдено:

![alt text](<4 observing_differences&behaviors_done-1.png>)
...
![alt text](<5 guessing&predicting_patterns-1.png>)
...
![alt text](<6 03 playing_with_the_patterns_burpsuit_attack-1.png>)
Результат запуску атаки "intuder" дасть схожі результати:
![alt text](<7 playing_with_the_patterns_burpsuit_attack_result-1.png>)
...
![alt text](<8 playing_with_the_patterns_edit_another_profile-1.png>)
...
![alt text](<9 playing_with_the_patterns_edit_another_profile_result-1.png>)
