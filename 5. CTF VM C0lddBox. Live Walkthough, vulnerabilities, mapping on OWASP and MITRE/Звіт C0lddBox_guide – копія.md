...
![alt text](<7 wpscan_password_attack-1.png>)
...
![alt text](<12 reverse_shell-1.png>)
...
![alt text](<22 vim-1.png>)

Запускаємо **vim** за допомогою **sudo**:

![alt text](<23 sudo_vim-1.png>)

Отримуємо **root** в **vim** 

![alt text](<24 vim_root-1.png>)
